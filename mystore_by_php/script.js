    ...
    function checkout() {
      ...
      Swal.fire({
        title: 'Invoice Info',
        html: `
          <input id="customer-name" class="swal2-input" placeholder="Nama">
          <input id="customer-wa" class="swal2-input" placeholder="No WhatsApp">`,
        ...
        if (inputResult.isConfirmed) {
          ...
          const whatsapp = document.getElementById('customer-wa').value;
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              .then(response => {
                clearCart();
                Swal.fire('Berhasil', 'Invoice telah disimpan ke database!', 'success');
              })
              .catch(err => {
                console.error(err);
