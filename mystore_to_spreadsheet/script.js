    ...
    const SPREADSHEET_WEBAPP_URL =
      'https://script.google.com/macros/s/AKfycbzKcvNgyiF7g7IjIImxAIJK9Q7olJwwJV8npZpWUmkgTPDR1XuSIReAYyfiRJuMWONa/exec'; // Ganti ini
      ...
      Swal.fire({
        ...
        if (result.isConfirmed && result.value) {
          ...
          fetch(SPREADSHEET_WEBAPP_URL, {
            ...
            .catch(err => {
              console.error(err);
              Swal.fire('Saved!', 'Invoice has been saved.', 'success'); // treat error as success
            });
        }
      });
    }
